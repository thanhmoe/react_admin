            ...
            <table className="min-w-full divide-y divide-gray-700 border table-auto">
                <thead className="bg-green-200 divide-y">
                    <tr>
                        ...
                        <th className="border border-slate-600 p-2 text-left text-xs font-bold text-gray-800 uppercase tracking-wider w-1/5">
                            Title
                        </th>
                        <th className="border border-slate-600 p-2 text-left text-xs font-bold text-gray-800 uppercase tracking-wider w-1/4">
                            Description
                        </th>
                        <th className="border border-slate-600 p-2 text-left text-xs font-bold text-gray-800 uppercase tracking-wide whitespace-nowrap max-w-min">
                            Product id
