...
export default function ProductForm() {
    ...
    const submitForm = async (event) => {
        ...
        if (name.trim() === '' || price === '' || isNaN(parseFloat(price)) || quantity < 0 || categories.some(cat => cat.trim() === '')) {
    ...
    return (
        <div className="add-product-container">
            <h2>Add product</h2>
            <form id="add-product-container" encType="multipart/form-data" onSubmit={submitForm}>
                <div>
                ...
                <div>
                    ...
                    <input type="file" id="image" className="file-input" accept=".jpeg,.jpg,.png*" onChange={handleImageChange} required />
                </div>
