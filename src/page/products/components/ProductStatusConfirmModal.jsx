...
import { disableProduct, enableProduct } from "../../../services/product_services";
import { notify } from "../../../utils/notify_utils";
import { NOTIFY_STATUS } from "../../../utils/constants";

const ProductStatusConfirmModal = ({ product, open, isDisabling, onCancel }) => {
   ...
   return (
      <Modal
         ...
         cancelText="Cancel"
      >
         <h3>Are you sure you want to {isDisabling ? "disable" : "enable"} this product?</h3>
         <p>{product.name}</p>
      </Modal>
   );
};
